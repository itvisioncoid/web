<main class="container">
	<div class="grid">
		<section>
			...
			<figure>
				<img src="/images/ashim-d-silva-3Ijt7UkSBYE-unsplash-1500x750.jpg" alt="Architecture">
				<figcaption>Image from <a href="https://unsplash.com/photos/3Ijt7UkSBYE" target="_blank" rel="external, noreferrer">unsplash.com</a></figcaption>
			</figure>
		...
		<aside>
			<a href="/" aria-label="Example" on:click|preventDefault>
				<img src="/images/maarten-deckers-T5nXYXCf50I-unsplash-1500x750.jpg" alt="Architecture">
			</a>
			<p>
